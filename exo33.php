...
<head>
    ...
    <title>Les relations en PHP afficher en HTML éviter la deuxième boucle foreach </title>
</head>
<body>
<div>
    <?php 
    ...
    ?>
    <!--Ce qui permet d’ajouter les entêtes de colonne HTML -->
    <h1>Les relations en PHP afficher en HTML éviter la deuxième boucle foreach </h1>
    <table>
        <tr>
            <th>Titre</th>
            <th>Pseudo</th>
