...
while ($resultat = mysqli_fetch_row($requete)) {// lire le résultat dans le tableau $resultat Si on désire uniquement un résultat avec des clefs nommées, on utilisera :" mysqli_fetch_row " pour associative
    echo '<pre>';
    print_r($resultat);
    echo '<br>';
    echo '</pre>';
